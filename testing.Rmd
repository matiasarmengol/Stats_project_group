...
Baseline_model_M0 <- lm(M0, data = selected)
...
#' model: the model we use to generate our predictions
#' data: the dataset we train the model on, probably SCS_demand_modelling
#' other_year: the (LOWER of the two) year whose weather we wish to 'import' into 2013/14 as a string
compare_winter <- function(model, data, other_year) {
  ...
  #create our specified set to train on
  other_set <- data |> 
