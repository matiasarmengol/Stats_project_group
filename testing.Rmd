...
for (model_name in names(models)) {
  results[[model_name]] <- cross_validation_fixed(models[[model_name]], big_set, grouping = group_var)
  # Print progress
  cat("Completed cross-validation for", model_name, "\n")
}
=======
M0_res <- cross_validation(Model_M0, selected, grouping=group_var)
...
cat("Model M5: \n")
print(M5_ind)
>>>>>>> 1776acc8a28dde6db4544a74bad053f786f3fc70
```
