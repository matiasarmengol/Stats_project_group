...
Our model, M5, has an overall adjusted $R^2$ of 0.7616418 and a fold-average of 0.7579201.The plots below compare these figures as well as the RMSE of each model. 

```{r compare_metrics, echo=FALSE, message=FALSE, fig.align = 'center'}
