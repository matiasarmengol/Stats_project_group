...
```{r covariate_matrix, echo=FALSE, message=FALSE, fig.align = 'center'}
...
```{r demand_vs_time_plots, echo=FALSE, message=FALSE, fig.align = 'center'}
...
```{r temp_demand, echo=FALSE, message=FALSE, fig.align = 'center'}
