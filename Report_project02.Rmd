...
# Assuming 'results_M0' and 'results_M5' are the outputs from k_fold_cross_validate function
...
flatten_cv_results <- function(results, model_name) {
  ...
  for (month_key in names(month_metrics)) {
    # Extract month name (remove 'month_' prefix)
...
# manually add the values into a data frame
