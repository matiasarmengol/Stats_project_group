...
```{r covariate_matrix, echo=FALSE, fig.align = 'center', fig.cap="This is a test caption, lets see hwo much I can waffle to see what would happen if the caption was particularly long, which is probably what we want given that we have to explain stuff precisely. Also lets see how wide the captions are generated, might need to tweak that later."}
...
```{r demand_vs_time_plots, fig.align = 'center', echo=FALSE, message=FALSE}
...
```{r temp_demand, echo=FALSE, fig.align = 'center', message=FALSE}
...
```{r compare_winter_plots, echo=FALSE, fig.align = 'center', message=FALSE}
