...
```{r demand_vs_day, echo=FALSE, message=FALSE, fig.align = 'center', fig.cap = 'Figure 4: Bar plot of average gross demand against day, for the days of Sunday, Monday, Tuesday, Wednesday, Thursday, Friday and Sunday. This highlights the difference between weekend days(Sunday and Saturday) and the other days.'}
SCS_demand_modelling %>%
  group_by(wdayindex) %>%
  summarize(avg_demand = mean(demand_gross, na.rm = TRUE)) %>%
